...
export const AppConfigurationCreateSchema = {
    properties: {
        config_key: {
            type: 'string',
            maxLength: 200,
    ...
    description: 'Schema for creating a new app configuration.'
} as const;

export const AppConfigurationPublicSchema = {
    properties: {
        config_key: {
            type: 'string',
            maxLength: 200,
...
export const AppConfigurationUpdateSchema = {
    properties: {
        config_key: {
            anyOf: [
                {
    ...
    description: 'Schema for updating an app configuration.'
} as const;

export const AppConfigurationsPublicSchema = {
    properties: {
        data: {
            items: {
    ...
    type: 'object',
    required: ['data', 'count'],
    title: 'AppConfigurationsPublic',
    description: 'Schema for list of app configurations.'
} as const;
